<%--This is the page for user to put email address for resetting password.--%>
                        ...
                        <form action="resetPassword" method="GET">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Submit"
                                       ...
                                       style="color:#024a26;"
                                       onclick="alert('A password reset link will be sent to your email, please have a check!')">
                            </div>
                        </form>
                    </div>
                </div>
