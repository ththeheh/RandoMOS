...
function addcomment() {
    ...
    var a6 = cm + "</p></div></div></div><br/>" +
        ...
        "                                        <textarea class='form-control' rows='5' id='reply"+ j +"'"+
        ...
        "                    </div>" +
        "                </div>";
    var a7 = "<ul id='list" + (i++) + "'></ul>";    //make this updated as per i; very
...
function addReply(list,replynum) {
    ...
    var a6 = reply + "</p></div></div></div><br/>" +
        ...
        "                                </form>" +
        "                                <div class='form-group'>" +
        "                                    <button type='submit' class='btn btn-primary btn-lg' data-dismiss='modal'  onclick='addReply(" + list + ","+j++ +")'>" +
        "                                        Submit!" +
        "                                    </button>" +
        "                                </div>" +
        "                            </div>" +
